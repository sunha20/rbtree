...
//    assert(p->left -> key == 1000);
//    assert(p->right -> key == 2000);
//    assert(p->left -> color == RBTREE_RED);
//    assert(p->right -> color == RBTREE_RED);

//    assert(p->left -> color == RBTREE_BLACK);
//    assert(p->right -> color == RBTREE_BLACK);

    assert(p->key == 1020);
    assert(p->left -> key == 1000);
    assert(p->right -> key == 1024);
    assert(p->left -> color == RBTREE_RED);
    assert(p->right -> color == RBTREE_RED);
#else
    assert(p->left != NULL);
